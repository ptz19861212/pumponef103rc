...
#ifndef __CONFIG_H2S_H__
#define __CONFIG_H2S_H__
...
// 气体名称
#define CONFIG_GAS_NAME_INDEX			GAS_NAME_INDEX_H2S
#define CONFIG_GAS_NAME_EN				"H2S"
#define CONFIG_GAS_NAME_CN				"硫化氢"
...
#if (CONFIG_H2S__100 == PRE_COMP_ENABLE)
	// 小数点
	#define CONFIG_GAS_POINT					POINT_HHHHH
	// 量程
	#define CONFIG_GAS_RANGE					100
	// 低报
	#define CONFIG_GAS_ALARM_LOWER			10
	// 高报
	#define CONFIG_GAS_ALARM_UPPER			20
	// STEL
	#define CONFIG_GAS_ALARM_STEL			10
	// TWA
	#define CONFIG_GAS_ALARM_TWA			10
	// ref1 数值
...
#elif (CONFIG_H2S__200 == PRE_COMP_ENABLE)
	// 小数点
	#define CONFIG_GAS_POINT					POINT_HHHHH
	// 量程
	#define CONFIG_GAS_RANGE					200
	// 低报
	#define CONFIG_GAS_ALARM_LOWER			20
	// 高报
	#define CONFIG_GAS_ALARM_UPPER			40
	// STEL
	#define CONFIG_GAS_ALARM_STEL			20
	// TWA
	#define CONFIG_GAS_ALARM_TWA			20
	// ref1 数值
	#define CONFIG_GAS_REF1_VALUE			0
	// ref1 ADC
	#define CONFIG_GAS_REF1_ADC				200
