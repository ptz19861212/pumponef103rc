...
#ifndef __CONFIG_CO_H__
#define __CONFIG_CO_H__
...
// 气体名称
#define CONFIG_GAS_NAME_INDEX			GAS_NAME_INDEX_CO
#define CONFIG_GAS_NAME_EN				"CO"
#define CONFIG_GAS_NAME_CN				"一氧化碳"
...
#define CONFIG_GAS_CALI_TIME_SEC				11
	...
	// 低报
	#define CONFIG_GAS_ALARM_LOWER			50
	// 高报
	#define CONFIG_GAS_ALARM_UPPER			100
	// STEL
...
#elif (CONFIG_CO__2000 == PRE_COMP_ENABLE)
	// 小数点
	#define CONFIG_GAS_POINT					POINT_HHHHH
	// 量程
