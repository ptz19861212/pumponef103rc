...
#ifndef __CONFIG_CH4O_H__
#define __CONFIG_CH4O_H__
...
// 气体名称
#define CONFIG_GAS_NAME_INDEX			GAS_NAME_INDEX_CH4O
#define CONFIG_GAS_NAME_EN				"CH4O"
#define CONFIG_GAS_NAME_CN				"甲醇"
...
#if (CONFIG_CH4O__100_0 == PRE_COMP_ENABLE)
	// 小数点
...
#elif (CONFIG_CH4O__100 == PRE_COMP_ENABLE)
