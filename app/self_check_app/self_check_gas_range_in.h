/**
 * @file    self_check_gas_range_in.h
 * @brief   气体名称自检
 * @author  ptz
...
#ifndef __SELF_CHECK_GAS_RANGE_IN_H__
#define __SELF_CHECK_GAS_RANGE_IN_H__
...
#define CONFIG_GAS_RANGE_POS						2
#define CONFIG_GAS_RANGE_LEN						11
