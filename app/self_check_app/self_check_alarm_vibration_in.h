/**
 * @file    self_check_alarm_vibration_in.h
 * @brief   报警震动自检
 * @author  ptz
...
#ifndef __SELF_CHECK_ALARM_VIBRATION_IN_H__
#define __SELF_CHECK_ALARM_VIBRATION_IN_H__
...
#define CONFIG_ALARM_VIBRATION_POS						2
#define CONFIG_ALARM_VIBRATION_LEN						15
